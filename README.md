...
| on_video_playback_end            | Configures the behavior of the video playback when it finishes before the 'display_time' elapses. (possible values are: repeat / pause / next). | repeat     |
